...
public class Dashboard {
	...
	public static void putNumbers() {
		...
		SmartDashboard.putNumber("USD_PIN_IN", RobotTemplate.USD_PIN_IN);
		SmartDashboard.putNumber("USD_PIN_OUT", RobotTemplate.USD_PIN_OUT);
	...
	public static void getNumbers() {
		...
		SmartDashboard.getNumber("USD_PIN_IN", RobotTemplate.USD_PIN_IN);
		SmartDashboard.getNumber("USD_PIN_OUT", RobotTemplate.USD_PIN_OUT);
